...
'''
def generateMultiplyExpression():
    exp = []
    exp.append('×')
    ...
    if exp[2] > 11:
        ...
        if rnd >= 15:
            return generateMultiplyExpression()
    return exp
...
'''
def generateDivisionExpression():
    exp = []
    exp.append('÷')
    o1 = makeRandomInt(2, 9)
    o2 = makeRandomInt(3, 9)
    exp.append(o1 * o2)
    exp.append(o1)
    return exp
